    ...
    <Wrapper>
      <main>
        ...
        <div className="container">
          ...
          <p>
            To be fair to everyone we collect a non-refundable $200 deposit to reserve a puppy. When
            you place a deposit you will be asked to select a puppy sex and a puppy color (black,
            chocolate, yellow). Pick of the litter and puppy pick up appointments are determined by
          ...
          <p>
            ...
            first pick of all of the chocolate females. As first pick, you could select your puppy
            at any time. If you were second pick, you could only select your puppy after the
            customer holding first pick made their choice... and so on.
          </p>
          <p>
          ...
          <p>We look forward to hearing from you. Give us a call to place your deposit.</p>
